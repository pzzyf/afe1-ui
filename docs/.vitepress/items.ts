export const components = [
  {
    ...
    items: [
      ...
      { text: 'Cell 单元格', link: '/components/basic/cell' },
      {
        ...
        link: '/components/basic/configprovider',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'ShortPassword 短密码',
        link: '/components/dentry/shortpassword',
      },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Badge 徽标', link: '/components/exhibition/badge' },
      {
        ...
        link: '/components/exhibition/circleprogress',
      },
      ...
      { text: 'Empty 空状态', link: '/components/exhibition/empty' },
      {
        ...
        link: '/components/exhibition/imagepreview',
      },
      { text: 'List 虚拟列表', link: '/components/exhibition/list' },
      {
        text: 'LoadingPage 加载页',
        link: '/components/exhibition/loadingpage',
      },
      ...
      {
        text: 'TrendArrow 趋势箭头',
        link: '/components/exhibition/trendarrow',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: 'AddressList 地址列表',
        link: '/components/business/addresslist',
      },
...
export const navComponents = components.map((i) => ({
  text: i.text,
  link: i.items[0].link,
}))
