...
var recurse = function (
  ...
  try {
    key: for (
      var _b = __values(node.keys()), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      const key = _c.value
...
const SearchableMap =
  ...
  (function () {
    ...
    SearchableMap2.prototype.atPrefix = function (prefix) {
      ...
      const _b = __read(
          trackDown(this._tree, prefix.slice(this._prefix.length)),
          2
        ),
        node = _b[0],
        path = _b[1]
      if (node === void 0) {
        const _c = __read(last(path), 2),
          parentNode = _c[0],
          key = _c[1]
        try {
          for (
            var _d = __values(parentNode.keys()), _e = _d.next();
            !_e.done;
            _e = _d.next()
          ) {
            const k = _e.value
            if (k !== LEAF && k.startsWith(key)) {
              const node_1 = /* @__PURE__ */ new Map()
    ...
    SearchableMap2.from = function (entries) {
      ...
      try {
        for (
          ...
          const _b = __read(entries_1_1.value, 2),
            key = _b[0],
            value = _b[1]
          tree.set(key, value)
        }
...
var trackDown = function (tree, key, path) {
  ...
  try {
    for (
      var _b = __values(tree.keys()), _c = _b.next();
      !_c.done;
      _c = _b.next()
    ) {
      const k = _c.value
...
var remove = function (tree, key) {
  const _a2 = __read(trackDown(tree, key), 2),
    node = _a2[0],
    path = _a2[1]
  if (node === void 0) {
    return
  ...
  if (node.size === 0) {
    ...
    const _b = __read(node.entries().next().value, 2),
      key_1 = _b[0],
      value = _b[1]
  ...
  (function () {
    function MiniSearch2(options) {
      ...
      this._options = __assign(
        ...
        {
          autoVacuum,
          searchOptions: __assign(
            __assign({}, defaultSearchOptions),
    ...
    MiniSearch2.prototype.add = function (document) {
      let e_1, _a2, e_2, _b, e_3, _c
      const _d = this._options,
      ...
      if (id == null) {
        throw new Error(
          'MiniSearch: document does not have ID field "'.concat(idField, '"')
        )
      }
      ...
      try {
        for (
          ...
          try {
            for (
              var tokens_1 = ((e_2 = void 0), __values(tokens)),
                tokens_1_1 = tokens_1.next();
              !tokens_1_1.done;
              tokens_1_1 = tokens_1.next()
            ) {
              const term = tokens_1_1.value
              const processedTerm = processTerm(term, field)
              if (Array.isArray(processedTerm)) {
                try {
                  for (
                    var processedTerm_1 =
                        ((e_3 = void 0), __values(processedTerm)),
                      processedTerm_1_1 = processedTerm_1.next();
                    !processedTerm_1_1.done;
                    processedTerm_1_1 = processedTerm_1.next()
                  ) {
                    const t = processedTerm_1_1.value
    ...
    MiniSearch2.prototype.addAll = function (documents) {
      ...
      try {
        for (
          var documents_1 = __values(documents),
            documents_1_1 = documents_1.next();
          !documents_1_1.done;
          documents_1_1 = documents_1.next()
        ) {
          const document_1 = documents_1_1.value
          this.add(document_1)
        }
      } catch (e_4_1) {
        e_4 = { error: e_4_1 }
    ...
    MiniSearch2.prototype.addAllAsync = function (documents, options) {
      ...
      const _a2 = options.chunkSize,
        chunkSize = _a2 === void 0 ? 10 : _a2
      const acc = { chunk: [], promise: Promise.resolve() }
      const _b = documents.reduce((_a3, document, i) => {
          const chunk2 = _a3.chunk,
    ...
    MiniSearch2.prototype.remove = function (document) {
      ...
      try {
        for (
          ...
          try {
            for (
              var tokens_2 = ((e_6 = void 0), __values(tokens)),
                tokens_2_1 = tokens_2.next();
              !tokens_2_1.done;
              tokens_2_1 = tokens_2.next()
            ) {
              const term = tokens_2_1.value
              const processedTerm = processTerm(term, field)
              if (Array.isArray(processedTerm)) {
                try {
                  for (
                    var processedTerm_2 =
                        ((e_7 = void 0), __values(processedTerm)),
                      processedTerm_2_1 = processedTerm_2.next();
                    !processedTerm_2_1.done;
                    processedTerm_2_1 = processedTerm_2.next()
                  ) {
                    const t = processedTerm_2_1.value
    ...
    MiniSearch2.prototype.removeAll = function (documents) {
      ...
      if (documents) {
        try {
          for (
            var documents_2 = __values(documents),
              documents_2_1 = documents_2.next();
            !documents_2_1.done;
            documents_2_1 = documents_2.next()
          ) {
            const document_2 = documents_2_1.value
    ...
    MiniSearch2.prototype.maybeAutoVacuum = function () {
      ...
      const _a2 = this._options.autoVacuum,
    ...
    MiniSearch2.prototype.conditionalVacuum = function (options, conditions) {
      ...
      if (this._currentVacuum) {
        ...
        this._enqueuedVacuum = this._currentVacuum.then(() => {
          const conditions2 = _this._enqueuedVacuumConditions
            ...
            case 2:
              ...
              try {
                for (
                  ...
                  ;(_d = __read(fieldsData_1_1.value, 2)),
                    (fieldId = _d[0]),
                    (fieldIndex = _d[1])
                  try {
                    for (
    ...
    MiniSearch2.prototype.vacuumConditionsMet = function (conditions) {
      ...
      let minDirtCount = conditions.minDirtCount,
    ...
    MiniSearch2.prototype.search = function (query, searchOptions) {
      ...
      try {
        for (
          ...
          const _b = __read(rawResults_1_1.value, 2),
            docId = _b[0],
            _c = _b[1],
            score = _c.score,
            terms = _c.terms,
    ...
    MiniSearch2.prototype.autoSuggest = function (queryString, options) {
      let e_14, _a2, e_15, _b
      if (options === void 0) {
        options = {}
      }
      options = __assign(
        __assign({}, this._options.autoSuggestOptions),
        options
      )
      ...
      try {
        for (
          var suggestions_1 = __values(suggestions),
    ...
    MiniSearch2.loadJS = function (js, options) {
      let e_16, _a2, e_17, _b, e_18, _c
      const index = js.index,
      ...
      const miniSearch = new MiniSearch2(options)
      ...
      try {
        for (
          var _d = __values(miniSearch._documentIds), _e = _d.next();
          !_e.done;
          _e = _d.next()
        ) {
      ...
      try {
        for (
          ...
          const _g = __read(index_1_1.value, 2),
            term = _g[0],
            data = _g[1]
          const dataMap = /* @__PURE__ */ new Map()
          try {
            for (
              var _h = ((e_18 = void 0), __values(Object.keys(data))),
                _j = _h.next();
              !_j.done;
              _j = _h.next()
            ) {
              const fieldId = _j.value
    ...
    MiniSearch2.prototype.executeQuery = function (query, searchOptions) {
      ...
      if (typeof query !== 'string') {
        const options_1 = __assign(
          __assign(__assign({}, searchOptions), query),
          {
            queries: void 0,
          }
        )
        const results_1 = query.queries.map((subquery) => {
      ...
      const options = __assign(
        __assign({ tokenize, processTerm }, globalSearchOptions),
        searchOptions
      )
      const searchTokenize = options.tokenize,
    ...
    MiniSearch2.prototype.executeQuerySpec = function (query, searchOptions) {
      ...
      const boosts = (options.fields || this._options.fields).reduce(
        (boosts2, field) => {
          ...
          return __assign(
            __assign({}, boosts2),
            ((_a3 = {}),
            (_a3[field] = getOwnProperty(options.boost, field) || 1),
            _a3)
          )
        },
        {}
      ...
      const _c = __assign(__assign({}, defaultSearchOptions.weights), weights),
      ...
      if (fuzzyMatches) {
        try {
          for (
            var _e = __values(fuzzyMatches.keys()), _f = _e.next();
            !_f.done;
            _f = _e.next()
          ) {
            var term = _f.value
    ...
    MiniSearch2.prototype.toJSON = function () {
      let e_22, _a2, e_23, _b
      const index = []
      try {
        for (
          var _c = __values(this._index), _d = _c.next();
          !_d.done;
          _d = _c.next()
        ) {
          const _e = __read(_d.value, 2),
            term = _e[0],
            fieldIndex = _e[1]
          const data = {}
          try {
            for (
              ...
              const _f = __read(fieldIndex_2_1.value, 2),
                fieldId = _f[0],
                freqs = _f[1]
        ...
        for (
          ...
          try {
            for (
              ...
              const weightedScore =
                termWeight * fieldBoost * docBoost * rawScore
    ...
    MiniSearch2.prototype.warnDocumentChanged = function (
      shortDocumentId,
      fieldId,
      term
    ) {
    ...
    MiniSearch2.prototype.addFields = function (fields) {
      for (const [i, field] of fields.entries()) {
        this._fieldIds[field] = i
      }
    }
    MiniSearch2.prototype.addFieldLength = function (
      documentId,
      fieldId,
      count,
      length
    ...
    MiniSearch2.prototype.removeFieldLength = function (
      documentId,
      fieldId,
      count,
      length
    ...
    MiniSearch2.prototype.saveStoredFields = function (documentId, doc) {
      ...
      try {
        for (
          var storeFields_1 = __values(storeFields),
            storeFields_1_1 = storeFields_1.next();
          !storeFields_1_1.done;
          storeFields_1_1 = storeFields_1.next()
        ) {
          const fieldName = storeFields_1_1.value
  ...
  (_a[OR] = function (a, b) {
    ...
    try {
      for (
        ...
        const docId = _c.value
        const existing = a.get(docId)
        if (existing == null) {
          a.set(docId, b.get(docId))
        } else {
          const _d = b.get(docId),
            score = _d.score,
            terms = _d.terms,
            match = _d.match
